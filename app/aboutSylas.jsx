...
const aboutapp = () => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.regularText}>
        Fun Fact about me is that I built my own desktop computer when I was 13 years old; I still use it today all the time and I've slowly upgrading its parts over the years.
      </Text>
